...
describe ReceiptItemsController do
  ...
  # ReceiptItem. As you add validations to ReceiptItem, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "receipt" => "" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # ReceiptItemsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all receipt_items as @receipt_items" do
      receipt_item = ReceiptItem.create! valid_attributes
  ...
  describe "GET show" do
    it "assigns the requested receipt_item as @receipt_item" do
      receipt_item = ReceiptItem.create! valid_attributes
      get :show, {:id => receipt_item.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested receipt_item as @receipt_item" do
      receipt_item = ReceiptItem.create! valid_attributes
      get :edit, {:id => receipt_item.to_param}, valid_session
      assigns(:receipt_item).should eq(receipt_item)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ReceiptItem" do
        expect {
          post :create, {:receipt_item => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved receipt_item as @receipt_item" do
        ...
        post :create, {:receipt_item => { "receipt" => "invalid value" }}, valid_session
        assigns(:receipt_item).should be_a_new(ReceiptItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested receipt_item" do
        ...
        ReceiptItem.any_instance.should_receive(:update).with({ "receipt" => "" })
        put :update, {:id => receipt_item.to_param, :receipt_item => { "receipt" => "" }}, valid_session
      end

      it "assigns the requested receipt_item as @receipt_item" do
        receipt_item = ReceiptItem.create! valid_attributes
        put :update, {:id => receipt_item.to_param, :receipt_item => valid_attributes}, valid_session
        assigns(:receipt_item).should eq(receipt_item)
      end
    ...
    describe "with invalid params" do
      it "assigns the receipt_item as @receipt_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ReceiptItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => receipt_item.to_param, :receipt_item => { "receipt" => "invalid value" }}, valid_session
        assigns(:receipt_item).should eq(receipt_item)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested receipt_item" do
      receipt_item = ReceiptItem.create! valid_attributes
      expect {
        delete :destroy, {:id => receipt_item.to_param}, valid_session
      }.to change(ReceiptItem, :count).by(-1)
    end
