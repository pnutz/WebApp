...
(function() {
  $(document).on('ready page:load', function() {
    var index, root_tree, treeDivs, treeLength;
    $("#foldertabs").tabs();
    ...
    return $("li.foldertab").click(function() {
      var divId;
      divId = $(this).find("a")[0].getAttribute('href');
      root_tree = $(divId);
      return root_tree.jstree("open_all");
    });
  });
...
(function() {
  $(document).on('ready page:load', function() {
    var receiptItemCount, updateTotal;
    $("#allReceipts").tablesorter();
    $("#receipt_date").datepicker();
    updateTotal = function(indexRemoved) {
      var currentName, index, item_cost, itemcost, receipt_index, total;
      ...
      while (index < item_cost.length) {
        ...
        if ($("[name='receipt[receipt_items_attributes][" + receipt_index + "][_destroy]']").val() === "false" && receipt_index !== indexRemoved) {
    ...
    $(document).on("keyup", ".item_cost", function() {
      updateTotal();
    });
    $(document).on("change", ".item_quantity", function() {
      updateTotal();
    });
    return $(document).on("keyup", ".item_quantity", function() {
      updateTotal();
    });
  });
